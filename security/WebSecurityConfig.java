...
import com.greatlearning.ems.serviceImpl.UserDetailServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(getMyUserDetailService()).passwordEncoder(getPassWordEncoder());
	}
	...
	public DaoAuthenticationProvider authenticationProvider() {
		...
		authProvider.setUserDetailsService(getMyUserDetailService());
